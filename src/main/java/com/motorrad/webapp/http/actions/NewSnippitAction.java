...
public class NewSnippitAction implements Action {
    public static final ActionID ID = new ActionID() {
        ...
        public Action makeAction(Services services) {
            return new NewSnippitAction();
        }
    };

    public NewSnippitAction() {
    ...
    public Resource execute(HttpContext httpContext) throws IOException {
        ...
        data.put("types", KickstartSnippitType.values());
        return new Page("NewSnippit.ftl", data);
    }
}
